...
to as \"the\" world because it is everything that exists. There is no
mathematical definition for it. Referring to multiple worlds or to \"a\"
world is an abuse of language indicating a model of the world that is
made up of multiple independent models.]{.vanity-contents}
